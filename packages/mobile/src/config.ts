...
//      Set this to the host's LAN IP (e.g. http://192.168.1.20:8080/v1) when
//      running on a PHYSICAL device, which can't reach the dev machine's localhost.
//   2. Platform default — Android emulator reaches the host at 10.0.2.2; the iOS
//      simulator (and anything else) uses localhost.
